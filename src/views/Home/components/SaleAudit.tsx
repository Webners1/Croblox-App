...
const SaleAudit = () => {
  ...
  const click = () => {
    window.open('https://hacken.io/wp-content/uploads/2021/10/BLOXSWAP_08102021SCAudit_Report_2.pdf', '_blank').focus();
  }
  return (
    <StyledCakeStats>
      <StyledCardBody onClick={click}>
        ...
        <Link
          small
          href="https://hacken.io/wp-content/uploads/2021/10/BLOXSWAP_08102021SCAudit_Report_2.pdf"
          target="_blank"
          mr="16px"
        >
          www.hacken.io
